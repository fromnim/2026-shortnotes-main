...
\item
A strong base favors elimination reaction over substitution reaction because that way it can abstract protons.

\item N-factor is defined as the number of electrons involved in a reduction or oxidation reaction per mole of the reactant for which you are calculating the n factor.

\item Boiling point is dependent on hydrogen bonding which itself is dependent on the electronegativity difference between the hydrogen bonded oxygen and oxygen. This is the major factor at play here.. because when we compare CH3NH2 and  CH3OH we find that CH3OH has higher boiling point..
despite CH3NH2 having more hydrogenbonding per molecule.
